...
namespace GetWith\CoffeeMachine\Infrastructure\UI\Console;
...
use GetWith\CoffeeMachine\Domain\Factory\CreateMessageHandlerFactory;
...
class MakeDrinkCommand extends Command
{
    ...
    public function __construct()
    {
        ...
        $this->get_drink_message_handler = CreateMessageHandlerFactory::build();
    }
